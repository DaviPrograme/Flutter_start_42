          ...
          for(int index = 0; index < time.length; ++index){
            rowsList.add(
              DataRow(cells: [
                ...
                DataCell(Text(translateSingleForecast(weathercode[index].toString()), style: const TextStyle(color: Colors.white))),
              ])
            );
          }
          return
    ...
    List<Widget> pages = [
      Center( child:
        Column(
          ...
          children: [
            Text("CURRENTLY", style: TextStyle(fontSize: fontTextSize, color: Colors.white)),
